...
const actionsheetContentStyle = tva({
  base: 'items-center p-5 pt-2 bg-background-0 shadow-hard-5',
});
...
const actionsheetSectionHeaderTextStyle = tva({
  base: 'leading-5 my-0 text-typography-500 p-3 capitalize',
  variants: {
    isTruncated: {
      true: '',
    },
...
>(function ActionsheetItemText(
  { isTruncated, bold = true, underline, strikeThrough, size = 'lg', className, ...props },
  ref
) {
  return (
